...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("beby") || body.startsWith("বেবি") || body.startsWith("বট")) {
            const arr = body.replace(/^\S+\s*/, "");
            const randomReplies = ["এইতো আমি এখানে 👻",
    "কিগো এত ডাকছো কেন প্রেম করবা 🫣",
    "আমাকে ডেকেছো 🤔",
    "এত ডেকো না প্রেমে পড়ে যাবে",
    "দিলে তো আমার কাঁচা ঘুমটা নষ্ট করে 😡"];
            if (!arr) {
